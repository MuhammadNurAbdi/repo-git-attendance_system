                        ...
                        <div class="full-width">
                            <div class="half-width">
                                ...
                                <div class="col-full">
                                    ...
                                    <input type="text" maxlength="18" name="nip" placeholder="Masukan NIP" class="input-field" value="<?php echo $result[0]["nip_dosen"]; ?>" required disabled />
                                </div>
                                <div class="col-full">
                                    <label for="nama_email">E-mail</label>
                                    <input type="text" maxlength="254" name="email" placeholder="Masukan E-mail" class="input-field" value="<?php echo $result[0]["email_dosen"]; ?>" required />
                                </div>
                                <div class="col-full">
                            ...
                            <div class="half-width">
                                ...
                                <div class="col-full">
                                    ...
                                    <input type="text" maxlength="20" name="fakultas" placeholder="Masukan nama Fakultas" class="input-field" value="<?php echo $result[0]["fakultas_dosen"]; ?>" required />
                                </div>
                                <div class="col-full">
                                    <label for="nama_prodi">Program Studi</label>
                                    <input type="text" maxlength="30" name="prodi" placeholder="Masukan Nama Prodi" class="input-field" value="<?php echo $result[0]["prodi_dosen"]; ?>" required />
                                </div>
                            </div>
                            <div class="box-mid">
