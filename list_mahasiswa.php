...
<body>
    ...
    <section class="home-section" style="background-color: #0C172D;">
        ...
        <table id="customers">
            ...
            $data = $pdo_conn->prepare("SELECT * FROM mahasiswa ORDER BY nama_mahasiswa ASC"); //query untuk mengambil data tabel
            $data->execute();
            ...
            ?>
                    <tr>
                        ...
                        <td><?php echo $row["gender_mahasiswa"]; ?></td>
                        <td><?php echo $row["email_mahasiswa"]; ?></td>
                        <td><?php echo $row["alamat_mahasiswa"]; ?></td>
                        <td><?php echo $row["fakultas_mahasiswa"]; ?></td>
                        <td><?php echo $row["prodi_mahasiswa"]; ?></td>
                        <td><a class="button" href='edit_mahasiswa.php?nim=<?php echo $row['nim_mahasiswa']; ?>'>Edit</a></td>
                        <td><a class="button" onclick="return confirmBtn();" href='logic/delete_mahasiswa.php?nim=<?php echo $row['nim_mahasiswa']; ?>'>Delete</a></td>
                    </tr>
            <?php
                }
            }
