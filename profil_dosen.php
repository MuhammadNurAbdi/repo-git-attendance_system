...
<body>
    ...
    <section class="home-section">
        ...
        <div class="form-container">
            ...
            $data = $pdo_conn->prepare("SELECT * FROM dosen WHERE nip_dosen=" . $_SESSION['nip']); //query untuk mengambil data tabel
            $data->execute();
            ...
            <div class="tab-content">
                ...
                <div id="data-pribadi" class="tab-pane fade in active">
                    <form action="" id="form-data" class="form-block" method="post">
                        <div class="full-width">
                            <div class="half-width">
                                <div class="col-full">
                                    <label for="nama_lengkap">Nama Lengkap</label>
                                    <input type="text" name="nama" placeholder="Masukan Nama" class="input-field" value="<?php echo $result[0]["nama_dosen"]; ?>" required disabled />
                                </div>
                                <div class="col-full">
                                    <label for="no_nip">NIP</label>
                                    <input type="text" name="nip" placeholder="Masukan NIP" class="input-field" value="<?php echo $result[0]["nip_dosen"]; ?>" required disabled />
                                </div>
                                <div class="col-full">
                                    <label for="nama_email">E-mail</label>
                                    <input type="text" name="email" placeholder="Masukan E-mail" class="input-field" value="<?php echo $result[0]["email_dosen"]; ?>" required disabled />
                                </div>
                                <div class="col-full">
                            ...
                            <div class="half-width">
                                <div class="col-full">
                                    ...
                                    <textarea class="textarea-field" name="alamat" id="textarea" required disabled><?php echo $result[0]["alamat_dosen"]; ?></textarea>
                                </div>
                                <div class="col-full">
                                    <label for="nama_fakultas">Fakultas</label>
                                    <input type="text" name="fakultas" placeholder="Masukan nama Fakultas" class="input-field" value="<?php echo $result[0]["fakultas_dosen"]; ?>" required disabled />
                                </div>
                                <div class="col-full">
                                    <label for="nama_prodi">Program Studi</label>
                                    <input type="text" name="prodi" placeholder="Masukan Nama Prodi" class="input-field" value="<?php echo $result[0]["prodi_dosen"]; ?>" required disabled />
                                </div>
                            </div>
                            <div class="box-mid">
                                <a href="edit_profil_dosen.php" class="btn-batal">Edit</a>
                            </div>
                        </div>
                    </form>
                </div>
