...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = $pdo_conn->prepare("INSERT INTO dosen (nip_dosen, nama_dosen, foto_dosen, email_dosen, gender_dosen, alamat_dosen, fakultas_dosen, prodi_dosen) 
    VALUES (:nip_dosen, :nama_dosen, :foto_dosen, :email_dosen, :gender_dosen, :alamat_dosen, :fakultas_dosen, :prodi_dosen)");
